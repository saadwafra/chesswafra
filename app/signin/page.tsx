      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8" ref={headerRef}>
            ...
            <p className="text-white/70">Sign in to continue your chess journey</p>
          </div>
          <div ref={cardRef}>
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-amber-500 focus:ring-amber-500/20"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-amber-500 focus:ring-amber-500/20"
                      required
                    />
                    <button
                      type="button"
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center text-white/70">
                    <input type="checkbox" className="mr-2 rounded border-white/20 bg-white/10 text-amber-500 focus:ring-amber-500/20" />
                    Remember me
                  </label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="border-amber-400/40 text-amber-200 bg-zinc-900/80 hover:bg-amber-900/20 hover:text-amber-300">
